...
public class AdditionalAddressDTO {
    @Schema(description = "имя дополнительного адреса")
    private String name;
    ...
    public AdditionalAddressDTO(String name, String city, String region, String street, int house, int subway, int floor, int apartment, int intercom) {
        this.name = name;
        this.city = city;
        this.region = region;
        this.street = street;
    ...
    public boolean equals(Object o) {
        ...
        AdditionalAddressDTO that = (AdditionalAddressDTO) o;
