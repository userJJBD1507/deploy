...
@Repository
public interface EntityAdditionalPhoneNumberRepository extends JpaRepository<AdditionalPhoneNumber, Id> {
    @Modifying
    @Transactional
    @Query("delete AdditionalPhoneNumber w where w.id=:id")
