...
public class DrivingLicenseControllerTest {
    ...
    @InjectMocks
    private DrivingLicenseController drivingLicenseController;
    ...
    void create_ShouldCallServiceAndReturnCreatedStatus() {
        ...
        // Act
        ResponseEntity<Void> response = drivingLicenseController.create(dto);

        // Assert
        verify(drivingLicenseService).create(USERNAME, dto);
    ...
    void read_ShouldReturnDto_WhenIdLinkedToUser() {
        ...
        when(drivingLicenseService.read(id)).thenReturn(Optional.of(dto));

        // Act
        ResponseEntity<DrivingLicenseDTO> response = drivingLicenseController.read(id);
    ...
    void update_ShouldCallServiceAndReturnNoContent_WhenAuthorized() {
        ...
        // Act
        ResponseEntity<Void> response = drivingLicenseController.update(id, dto);

        // Assert
        verify(drivingLicenseService).update(id, dto, personalData.getDocuments().getId());
    ...
    void delete_ShouldCallServiceAndReturnNoContent_WhenAuthorized() {
        ...
        // Act
        ResponseEntity<Void> response = drivingLicenseController.delete(id);

        // Assert
        verify(drivingLicenseService).delete(id);
        assertEquals(HttpStatus.NO_CONTENT, response.getStatusCode());
    }
