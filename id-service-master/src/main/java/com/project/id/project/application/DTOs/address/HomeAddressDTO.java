...
public class HomeAddressDTO {
    @Schema(description = "имя домашнего адреса")
    private String name;
    ...
    public HomeAddressDTO(String name, String city, String region, String street, int house, int subway, int floor, int apartment, int intercom) {
        this.name = name;
        this.city = city;
        this.region = region;
        this.street = street;
    ...
    public boolean equals(Object o) {
        ...
        HomeAddressDTO that = (HomeAddressDTO) o;
