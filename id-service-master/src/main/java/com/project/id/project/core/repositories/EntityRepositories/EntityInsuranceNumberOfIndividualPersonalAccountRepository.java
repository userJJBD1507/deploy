...
@Repository
public interface EntityInsuranceNumberOfIndividualPersonalAccountRepository extends JpaRepository<InsuranceNumberOfIndividualPersonalAccount, Id> {
    @Modifying
    @Transactional
    @Query("delete InsuranceNumberOfIndividualPersonalAccount w where w.id=:id")
